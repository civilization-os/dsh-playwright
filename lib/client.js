...
var zh = {
  ...
  runbooks: "\u64CD\u4F5C\u624B\u518C",
  runbooksIntro: "\u7BA1\u7406\u7528\u6237\u660E\u786E\u8981\u6C42\u4FDD\u5B58\u7684\u6D4F\u89C8\u5668\u6D41\u7A0B\u3002",
  runbooksEmpty: "\u8FD8\u6CA1\u6709\u64CD\u4F5C\u624B\u518C\u3002\u5B8C\u6210\u9875\u9762\u4EFB\u52A1\u540E\uFF0C\u53EF\u4EE5\u8981\u6C42\u6A21\u578B\u4FDD\u5B58\u672C\u6B21\u6D41\u7A0B\u3002",
...
var en = {
  ...
  runbooksIntro: "Manage browser procedures saved at the user\u2019s explicit request.",
  runbooksEmpty: "No operation manuals yet. After finishing a browser task, ask the model to save the procedure.",
...
function BrowserSettings({ t, useBrowser, request }) {
  ...
  (0, import_react.useEffect)(() => setDraft(state.configured), [state.configured]);
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "dsh-pw-card", children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "dsh-pw-form", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
          t("browser"),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", { value: draft.browser, onChange: (event) => setDraft({ ...draft, browser: event.target.value }), children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "dsh-pw-mode", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", "aria-pressed": !draft.headless, onClick: () => setDraft({ ...draft, headless: false }), children: t("headed") }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", "aria-pressed": draft.headless, onClick: () => setDraft({ ...draft, headless: true }), children: t("headless") })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
          t("timeout"),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { type: "number", min: "1000", max: "120000", value: draft.timeoutMs, onChange: (event) => setDraft({ ...draft, timeoutMs: Number(event.target.value) }) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
          t("viewport"),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "dsh-pw-mode", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { "aria-label": "width", type: "number", value: draft.width, onChange: (event) => setDraft({ ...draft, width: Number(event.target.value) }) }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", { "aria-label": "height", type: "number", value: draft.height, onChange: (event) => setDraft({ ...draft, height: Number(event.target.value) }) })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "dsh-pw-actions", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", disabled: state.saving, onClick: () => request("save", draft), children: t(state.saving ? "saving" : "save") }) })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "dsh-pw-card", children: [
